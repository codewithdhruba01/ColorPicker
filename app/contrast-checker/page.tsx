      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        <main className="flex-1 container mx-auto px-4 pt-36 sm:pt-40">
          <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8">
              ...
              <Card className="p-6 sm:p-8 space-y-6">
                ...
                <div className="space-y-4">
                  <ComplianceCard
                    ...
                    description="Minimum contrast ratio of 4.5:1 for text smaller than 18pt (or 14pt bold)"
                    ratio="4.5:1"
                    passes={wcagAANormal}
                  ...
                  <ComplianceCard
                    ...
                    description="Minimum contrast ratio of 3:1 for text 18pt+ (or 14pt+ bold)"
                    ratio="3:1"
                    passes={wcagAALarge}
                    currentRatio={contrastRatio}
                  />
                  ...
                  <ComplianceCard
                    ...
                    description="Minimum contrast ratio of 7:1 for all text (enhanced accessibility)"
                    ratio="7:1"
                    passes={wcagAAA}
                    currentRatio={contrastRatio}
                  />
                ...
                <div className="pt-6 border-t">
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground dark:text-white/60">
                    <p>• AA compliance is the minimum legal requirement</p>
                    <p>• AAA compliance provides enhanced accessibility</p>
                    <p>• Higher ratios improve readability for everyone</p>
                  </div>
                </div>
              </Card>
            </div>
            ...
            <Card className="p-6 sm:p-8 bg-gradient-to-br from-cyan-500/5 to-orange-500/5">
              <div className="flex items-start gap-4">
                <AlertCircle className="w-6 h-6 text-cyan-500 flex-shrink-0 mt-1" />
                <div className="space-y-2">
                  <h3 className="font-semibold text-lg">Accessibility Tips</h3>
                  <ul className="space-y-2 text-sm text-muted-foreground dark:text-white/60">
                    <li>• Test your color combinations in different lighting conditions</li>
                    <li>• Consider users with color vision deficiencies</li>
                    <li>• Use additional indicators beyond color alone (icons, patterns)</li>
                    <li>• Maintain consistent contrast ratios across your design</li>
