            ...
            <Card className="p-6 sm:p-8 space-y-8">
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground dark:text-white/70 leading-relaxed">
                  By accessing and using ColorKit (the Service), you accept and agree to be bound by the terms
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-3 text-muted-foreground dark:text-white/70">
                  <h3 className="text-lg font-semibold text-foreground dark:text-white">2.1 Permitted Use</h3>
                  <p className="leading-relaxed">
                    ColorKit is provided as a free tool for color exploration, analysis, and accessibility testing.
                  ...
                  <h3 className="text-lg font-semibold text-foreground dark:text-white mt-4">2.2 Prohibited Use</h3>
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground dark:text-white/70 leading-relaxed">
                  The Service and its original content, features, and functionality are owned by ColorKit and are
                  protected by international copyright, trademark, patent, trade secret, and other intellectual
                  property laws.
                </p>
                <p className="text-muted-foreground dark:text-white/70 leading-relaxed">
                  Colors generated, extracted, or analyzed through the Service are not subject to copyright and
                  may be used freely in your projects. However, the tools, algorithms, and interface design of
                  ColorKit remain our intellectual property.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground dark:text-white/70">
                  <li>All processing happens in your browser - images are not stored on our servers</li>
                  <li>You retain all rights to your uploaded content</li>
                  <li>You are responsible for ensuring you have the right to use any images you upload</li>
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground dark:text-white/70">
                  ...
                  <li>Warranties regarding the accuracy or reliability of color analysis results</li>
                </ul>
                <p className="text-muted-foreground dark:text-white/70 leading-relaxed mt-3">
                  While we strive for accuracy in our accessibility testing and contrast checking, you should
                  verify critical accessibility requirements using multiple tools and methods.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground dark:text-white/70 leading-relaxed">
                  In no event shall ColorKit, its directors, employees, partners, agents, suppliers, or affiliates
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground dark:text-white/70">
                  ...
                  <li>Any reliance on color analysis or accessibility testing results</li>
                </ul>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground dark:text-white/70 leading-relaxed">
                  ...
                  part thereof) with or without notice. You agree that we shall not be liable to you or any third
              ...
              <div className="pt-6 border-t">
                <p className="text-sm text-muted-foreground dark:text-white/60 text-center">
                  By using ColorKit, you acknowledge that you have read and understood these Terms of Service
