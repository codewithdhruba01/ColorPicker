        ...
        <div className="container mx-auto px-4 py-12 sm:py-16 md:py-20">
          <div className="text-center space-y-6 sm:space-y-8 animate-fade-in-up max-w-5xl mx-auto mb-12 sm:mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 backdrop-blur-sm border border-cyan-500/20 mb-4">
              ...
              <span className="text-xs sm:text-sm font-medium text-cyan-400 dark:text-cyan-400">100% Free & Instant</span>
            </div>
          ...
          <div className="text-center mb-12">
            <Link href="/picker">
              <Button
                size="lg"
                className="text-base sm:text-lg px-8 sm:px-10 py-6 sm:py-7 bg-gradient-to-r from-orange-500 to-cyan-500 hover:from-orange-600 hover:to-cyan-600 dark:bg-white dark:text-black dark:hover:bg-white/90 rounded-full font-semibold shadow-2xl"
              >
