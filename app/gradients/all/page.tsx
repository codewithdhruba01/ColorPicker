...
export default function AllGradientsPage() {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-stone-950 flex flex-col overflow-x-hidden">
      {/* Background */}
      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        <main className="flex-1 container mx-auto pt-36 sm:pt-40 pb-10 px-4 sm:px-6">
          ...
          >
            ...
            {/* Category Buttons */}
            <motion.div
              className="flex flex-wrap justify-center gap-2 w-full px-2 sm:px-0"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            {/* Gradients Grid */}
            <motion.div
              className="w-full mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6"
              initial="hidden"
              animate="visible"
              variants={{
                hidden: {},
            ...
            >
              {filteredGradients.length === 0 ? (
                ...
                filteredGradients.map((gradient) => (
                  ...
                  >
                    <Card className="group overflow-hidden hover:shadow-2xl transition-all rounded-2xl">
                      {/* Gradient Preview */}
                      <div
