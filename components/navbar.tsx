...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[90%] sm:w-[80%] md:w-[40%] lg:w-[40%]">
      <div className="relative flex items-center justify-between px-5 py-3 rounded-full 
      ...
      {isOpen && (
        <div className="absolute right-0 mt-3 w-full bg-background/70 backdrop-blur-lg 
          ...
          <div className="pt-2 border-t border-border/20 flex justify-between items-center">
            <span className="text-xs text-foreground/60 dark:text-white/60">Theme</span>
            <ThemeToggle />
          </div>
        </div>
      )}
