        ...
        <section className="bg-background py-8 md:py-12">
            <div className="mx-auto max-w-7xl px-4 md:px-8">
                <div className="flex flex-col gap-8">
                    <p className="text-center text-md font-medium text-muted-foreground">Join 4,000+ companies already growing</p>
                    <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 xl:gap-x-6">
                        ...
                        <img
                            ...
                            className="h-9 opacity-85 hidden dark:block md:h-12"
                        />
                        <img
                            alt="Kintsugi"
